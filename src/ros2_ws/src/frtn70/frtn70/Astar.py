...
def astar(initial_state, goal_state, obstacles, heuristic):
    ...
    start_node.heuristic = heuristic(initial_state, goal_state)  # Calculate heuristic for start node
    ...
    while open_list:
        ...
        for action, successor_state, step_cost in successors(current_node.state, obstacles):
            ...
            new_node.heuristic = heuristic(successor_state, goal_state)  # Calculate heuristic for new node
...
initial_state = (0, 0, 0)
goal_state = (4, 4, 4)
obstacles = [(1, 1, 1), (2, 2, 2), (3, 3, 3)]  # Example obstacle positions

path = astar(initial_state, goal_state, obstacles, manhattan_distance)
